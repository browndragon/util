...
namespace BDUtil
{
    ...
    public class None<T> : ICollection<T>, IReadOnlyCollection<T>, IReadOnlyList<T>, IEnumerator<T>
    {
        ...
        T IReadOnlyList<T>.this[int index] => throw new IndexOutOfRangeException("i <> [0, 0)");
