...
namespace BDUtil.Screen
{
    public static class CameraExt
    {
        ...
        => thiz.transform.position = Vector3.SmoothDamp(thiz.transform.position, thiz.transform.position + delta, ref velocity, smoothTime, maxSpeed: float.PositiveInfinity, deltaTime: Time.smoothDeltaTime);
    }
}